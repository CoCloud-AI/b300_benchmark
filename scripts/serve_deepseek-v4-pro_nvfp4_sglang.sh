#!/bin/bash
# serve_deepseek-v4-pro_nvfp4_sglang.sh
...
#
# DeepSeek-V4-Pro NVFP4 on B300 TP=8, driver 610.43.02, SGLang 0.5.14.
#
# Model: nvidia/DeepSeek-V4-Pro-NVFP4 (851 GB)
#   - model_type: deepseek_v4 / DeepseekV4ForCausalLM (MLA lineage of R1/V3)
#   - 61 layers, hidden=4096, 64 heads, 1 KV head, q_lora_rank=1024
...
mkdir -p ~/benchmark/results_610/sglang/deepseek-v4-pro/{json,logs}
